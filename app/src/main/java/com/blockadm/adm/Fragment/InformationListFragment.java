...
public class InformationListFragment extends BaseFragment<InformationListPresenter, InformationListModel> implements InformationListContract.View {
    ...
    public InformationListFragment(int i, AppBarLayout appBarLayout,int id) {
        super();
        type = i;
  ...
  private String memberId;
    public InformationListFragment(String memberId) {
        super();
