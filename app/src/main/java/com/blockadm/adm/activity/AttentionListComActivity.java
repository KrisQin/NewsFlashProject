 ...
 */
@Route(path = "/app/index/AttentionListComActivity")
public class AttentionListComActivity extends BaseComActivity {
    @BindView(R.id.tilte)
    BaseTitleBar tilte;
    ...
    private void initView() {
        ...
        swipeToLoadLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh() {
                pageNum= 1;
                recordsBeans.clear();
                CommonModel.pageConcern(GsonUtil.GsonString(new PageBean(pageNum,pageSize,id)),myObserver);
            }
        });
