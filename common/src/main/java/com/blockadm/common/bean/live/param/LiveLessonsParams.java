 ...
 * @Describe TODO {  }
 */
public class LiveLessonsParams {
    ...
    public LiveLessonsParams(String nickName, int pageNum, int pageSize,
                             String title) {
    ...
    public LiveLessonsParams(String nickName, int pageNum, int pageSize, Integer sysTypeId,
                             String title) {
        this.nickName = nickName;
        this.pageNum = pageNum;
        this.pageSize = pageSize;
