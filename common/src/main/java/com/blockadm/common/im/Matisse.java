...
import com.blockadm.common.im.call.OnCheckedListener;
import com.blockadm.common.im.call.OnSelectedListener;
import com.blockadm.common.im.call.ResultCallback;
import com.blockadm.common.im.entity.CaptureStrategy;
...
public final class Matisse {
    ...
    public static void defaultFrom(Activity activity, int resCode, ResultCallback resultCallback) {
...
//                                            .imageEngine(new GlideEngine())
                ...
                .forResult(resCode,resultCallback);
    }


    public static void defaultFrom(Activity activity, IUIKitCallBack callBack, ResultCallback resultCallback) {
        Matisse.from(activity)
                .choose(MimeType.ofAll(), false)
                .countable(true)
                .capture(false)//是否可拍照
                ...
                .forResult(callBack,resultCallback);
    }
