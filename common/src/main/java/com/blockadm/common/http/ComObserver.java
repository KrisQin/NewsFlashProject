...
public  abstract class ComObserver<T> implements Observer<BaseResponse<T>> {
...
//            return;
    ...
    public void onError(Throwable e) {
        ...
        Log.i("responseInterceptoronError",errorMsg);
    ...
    public abstract void onSuccess(BaseResponse<T> response,String errorMsg);
